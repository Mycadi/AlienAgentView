  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-[12px]">
        ...
        <div className="flex items-center gap-[12px] shrink-0 pr-[22px]">
...
function MutedIcon() {
  return (
    <svg className="w-[14px] h-[14px] text-text-muted" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
function UnmutedIcon() {
  return (
    <svg className="w-[14px] h-[14px] text-text-secondary" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M11 5 6 9H2v6h4l5 4V5z" />
