...
const navItems: { id: Page; labels: { zh: string; en: string }; icon: ReactNode }[] = [
  ...
  { id: 'chat', labels: { zh: '对话', en: 'Chat' }, icon: <IconChat /> },
...
function IconChat() { return <svg className="w-[18px] h-[18px]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M4 5.5h16a1.5 1.5 0 0 1 1.5 1.5v8a1.5 1.5 0 0 1-1.5 1.5H9l-4 3.5V16.5H4A1.5 1.5 0 0 1 2.5 15V7A1.5 1.5 0 0 1 4 5.5z"/><path d="M7 10h10M7 13h6"/></svg>; }
